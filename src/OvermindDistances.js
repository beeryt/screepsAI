     ...
     */
    function applyDistanceTransform(foregroundPixels, oob) {
        if (oob === void 0) { oob = 255; }
    ...
    exports.displayCostMatrix = displayCostMatrix;
    function testDistanceTransform(roomName) {
        if (roomName === void 0) { roomName = 'sim'; }
        var dt = applyDistanceTransform(walkablePixelsForRoom(roomName));
        displayCostMatrix(dt);
    }
    exports.testDistanceTransform = testDistanceTransform;
    function distanceTransform(roomName) {
        return applyDistanceTransform(walkablePixelsForRoom(roomName));
    }
    exports.distanceTransform = distanceTransform;
